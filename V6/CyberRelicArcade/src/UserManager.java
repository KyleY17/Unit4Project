...
public class UserManager {
    ...
    private Map<String, String> users;           // username -> hashed_password
    private Map<String, Long> highScores;        // username -> high score
    private Map<String, Long> coins;             // username -> coins
    private Map<String, Set<String>> shopItems;  // username -> set of purchased item IDs
